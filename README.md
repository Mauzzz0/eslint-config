...
```shell
npm i -D @eslint/js@9 @typescript-eslint/eslint-plugin@8 @typescript-eslint/parser@8 eslint@9 eslint-config-prettier@10 eslint-plugin-import@2 eslint-plugin-prettier@5 eslint-plugin-simple-import-sort@12 eslint-plugin-unused-imports@4 eslint-import-resolver-typescript@4 prettier@3 typescript-eslint@8
```
